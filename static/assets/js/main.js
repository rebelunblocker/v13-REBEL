...
if(window.location.pathname === "/index.html" || window.location.pathname === "/") {
  ...
  const options = ["Right-Click to access more features", "Set a custom background in settings.", "Jesse likes big black men" , "Ghosting is highly recommended", "Hosted on the best hardware! (I'm lying)", "Share this link with everyone.",  "Customize Rebel by going to Settings > Themes", "2024-2025 WE BACK BITCHES", "Ali is 10 ft and has a 20 r34s", "Braylon has a gaint wiener", "bodies's british ass lol", "Ben has 23 and a half kids in his basment", "Vaylin goku meatrider", "Linux is now Acceseable on chromebooks! email at odmstag@gmail.com to get your linux hack"];
